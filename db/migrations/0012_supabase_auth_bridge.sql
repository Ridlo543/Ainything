-- Migration 0012: Supabase Auth -> app_users bridge
--
...
-- it does nothing.
--
-- LOCAL DEV: migration 0011_local_auth_stub.sql creates a stub auth schema
-- + users table. This migration is guarded so it only creates triggers when
-- auth.users exists (Supabase or local stub).

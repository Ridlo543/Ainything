...
const logos = [
	{
		src: 'static/images/ainything-logo-nobackground.png',
		dst: 'static/images/ainything-logo-nobackground.webp',
		size: 512
	},
	{
		src: 'static/images/ainything-logo-white.png',
		dst: 'static/images/ainything-logo-white.webp',
		size: 512
	}
];

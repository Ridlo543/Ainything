<script lang="ts">
	...
	const testimonials = [
		{
			quote: 'Sekarang pelanggan bisa pesan sendiri dari meja. Antrian berkurang drastis, omzet naik 30% dalam sebulan pertama karena tidak ada pesanan yang terlewat.',
			name: 'Budi Santoso',
...
<section class="border-t border-[#e7e5e4] bg-white py-20 sm:py-28">
	<div class="app-container">
		<div class="text-center">
			...
			<h2 class="text-3xl font-extrabold text-[#1a1a2e] sm:text-4xl">Dipercaya bisnis dari seluruh Indonesia</h2>
		...
		<div class="mt-14 rounded-2xl border border-[#e7e5e4] bg-[#fafaf9] px-6 py-5">
			<p class="mb-4 text-center text-xs font-semibold uppercase tracking-wider text-[#78716c]">Digunakan oleh bisnis dari</p>
